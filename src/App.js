    ...
    <div className="App">
      <div className="App-header">
        <div className="price-table">
          ...
          <mui.Button color="secondary" href="#" sx={{width:"100%", minHeight:"50px", borderRadius:"0px"}}  variant="contained">Buy</mui.Button>  
        </div>
        <div className="price-table">
        <div className="title" style={{backgroundColor:'#fe2100'}}>
            <h2>Plus</h2>
            <b>$9/month</b>
          </div>
          <div className="content">
        ...
        <div className="price-table">
        <div className="title" style={{backgroundColor:'green'}}>
            <h2>Pro</h2>
            <b>$49/month</b>
          </div>
          <div className="content">
